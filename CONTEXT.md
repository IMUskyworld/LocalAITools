...
- **已打包（v0.3.2，2026-09-15 含远控链路根治 + 状态信封 null 修复；2026-09-18 更新含 PDF 修复）**：`LocalMind.exe`（21.4MB，SHA256 `0283ADD4DF46726E743742ED657301AA5F20F22B3F1411B3B387698C533C2B69`）+ `LocalMindSetup.exe`（51.4MB，SHA256 `0000F17D159BEE61CA2A82954F3F6008C41D2CE5FF26944E061A3FFB8CD3A0D8`）+ `LocalFile.apk`（16.0MB，versionCode 3，SHA256 `395CC43E277E412B187FC89ABFC2955ABB1BBD2B7F3EF10AC4E0BA389FD91274`）+ `LocalMindScripts/make_doc.exe`（24.5MB，SHA256 `11A46359EFFB96B7EAE040B1941E5E07B7718C1E122ECBC8AD945C5F80B69F80`）。
