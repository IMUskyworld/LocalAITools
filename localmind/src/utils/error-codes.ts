...
const errorRegistry: Record<string, ErrorCodeInfo> = {
  ...
  '403003': { level: 'warn', message: '该邮箱已注册', message_en: 'Email is already registered' },
  '403004': { level: 'warn', message: '邮箱或密码错误', message_en: 'Invalid email or password' },
  '403005': { level: 'warn', message: '登录令牌无效或已过期', message_en: 'Token is invalid or expired' },
  '403006': { level: 'error', message: '账号已被禁用', message_en: 'Account is disabled' },
  '403007': { level: 'warn', message: '设备尚未绑定到该账号', message_en: 'Device is not enrolled in this account' },
  '403008': { level: 'warn', message: '控制授权请求已过期', message_en: 'Pairing request expired' },
  '403009': { level: 'warn', message: '设备已绑定到其他账号', message_en: 'Device is already enrolled in another account' },
  '403010': { level: 'warn', message: '控制授权请求状态冲突', message_en: 'Pairing request state conflict' },
